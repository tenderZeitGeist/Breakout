...
namespace config {
    ...
    static constexpr int scoreWidth = config::slotWidth * 4;
    static constexpr int scoreHeight = config::slotHeight * 5;
    static constexpr int scoreSpacing = 10;
    ...
    static constexpr SDL_Color kWhiteColor = {0xff, 0xff, 0xff, 0xff };
